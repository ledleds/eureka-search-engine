...
app.post('/search', urlencodedParser, function(req, res) {
  ...
  db.any('SELECT * FROM weburlsandcontent', {
      ...
      var index = lunr(function () {
        ...
        idRef_array = index.search(query);
        console.log(idRef_array);
        // res.render('search_results', {idRef_array: idRef_array, store: store, query: query});
